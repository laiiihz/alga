...
@ProviderFor(regexExpression)
final regexExpressionProvider =
    AutoDisposeProvider<RichTextController>.internal(
  regexExpression,
...
/// See also [regexValue].
@ProviderFor(regexValue)
final regexValueProvider = AutoDisposeProvider<RegExpValue>.internal(
  regexValue,
...
@ProviderFor(regexInputController)
final regexInputControllerProvider =
    AutoDisposeProvider<RichTextController>.internal(
