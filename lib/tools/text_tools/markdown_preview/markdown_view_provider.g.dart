...
@ProviderFor(markdownController)
final markdownControllerProvider =
...
@ProviderFor(markdownValue)
final markdownValueProvider = AutoDisposeProvider<String>.internal(
  markdownValue,
